...
uint8_t color_lum_min_b = 80;
uint8_t color_lum_max_b = 180;
uint8_t color_cb_min_b  = 128;
uint8_t color_cb_max_b  = 255;
uint8_t color_cr_min_b  = 128;
uint8_t color_cr_max_b  = 255;
...
{
  // Filter
  color_count_b = image_yuv422_colorfilt(img, img,
