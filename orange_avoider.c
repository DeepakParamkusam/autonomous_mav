...
int tresholdColorCount2         = 0.90 * 124800; // 520 x 240 = 124.800 total pixels
int tresholdDiv                 = 0.2; // Threshold of divergence
...
void orange_avoider_periodic()
{
  ...
  safeToGoForwards = (color_count < tresholdColorCount) && (color_count_g > tresholdColorCount2) && (opticflow_result.div_size < tresholdDiv);
...
//
//void avoider_opticflow_cb(uint8_t sender_id __attribute__((unused)),
